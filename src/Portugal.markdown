...
totality of the revenue from such unauthorized uses.[^portugal_79]

Civil actions include: (i) rights of prior communications, information
and supervision[^portugal_80]; (ii) specific evidence gathering and preservation
measures[^portugal_81]; (iii) provisional and preliminary injunctions (which
include both copyright specific measures and those available under the
general civil procedure law)[^portugal_82]: and (iv) measures to redress
...
the “Damages” section.[^portugal_83] / [^portugal_84]). The possibility of application of
some of these measures or their application above a certain threshold is
limited to infringing acts occurring on a commercial scale.[^portugal_85]
...
matter.[^portugal_86] This is coherent with the Software Act’s specific provision
on the seizure of counterfeit software copies.[^portugal_87] Under this
...
may have been applied to protect a computer program.[^portugal_88]
...
societies.[^portugal_89] In Portugal, the only collecting society representing
software rights holders is ASSOFT - Associação Portuguesa de
Software.[^portugal_90] Importantly, the position of exclusive or non-exclusive
...
agreement in a judicial action) to benefit from said measures.[^portugal_91] In
...
legal scholarship believes it to be invalid.[^portugal_92]
...
to Law 109/91, of 17 August[^portugal_94], which has been replaced by the new
Cybercrime Act.[^portugal_95] The articulation of the relevant legal instruments
...
infringement.[^portugal_96] That being the case, the Cybercrime Act limits the
...
sentences up to three years and/or equivalent fines.[^portugal_97] The attempted
form of the unlawful acts is punishable, as are acts carried out by
legal persons.[^portugal_98] Additionally, the court may rule as lost in favor of
...
mention to non-economic damages.[^portugal_242] Notwithstanding, it is our
